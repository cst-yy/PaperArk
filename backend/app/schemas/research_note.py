...
class ResearchProfileResponse(BaseModel):
    id: UUID; note_id: UUID; revision: int; background: str; prior_work_limitations: str; research_problem: str; method_summary: str; results_summary: str; conclusion: str; limitations: str; future_work: str; my_thoughts: str
